$(document).ready(function () {
	...
	$('a[aria-controls="tab-4"]').on('shown.bs.tab', function (event) {
		if ($('.program__content--4').length) {
			Scrollbar.init(document.querySelector('.program__content--4'), {
				damping: 0.1,
				renderByPixels: true,
				alwaysShowTracks: true,
				continuousScrolling: true
	...
	$('a[aria-controls="tab-5"]').on('shown.bs.tab', function (event) {
		if ($('.program__content--5').length) {
			Scrollbar.init(document.querySelector('.program__content--5'), {
				damping: 0.1,
				renderByPixels: true,
				alwaysShowTracks: true,
				continuousScrolling: true
	...
	$('a[aria-controls="tab-6"]').on('shown.bs.tab', function (event) {
		if ($('.program__content--6').length) {
			Scrollbar.init(document.querySelector('.program__content--6'), {
				damping: 0.1,
				renderByPixels: true,
				alwaysShowTracks: true,
				continuousScrolling: true
	...
	$('a[aria-controls="tab-7"]').on('shown.bs.tab', function (event) {
		if ($('.program__content--7').length) {
			Scrollbar.init(document.querySelector('.program__content--7'), {
				damping: 0.1,
				renderByPixels: true,
				alwaysShowTracks: true,
				continuousScrolling: true
