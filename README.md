...
The first-ever IAU Symposium in Malaysia and the largest professional astronomy conference in Malaysia to date.
...
Connecting near-field cosmology with high-redshift observations, focusing on:
- First-year JWST and ALMA data
- The Local Group in a cosmological context
- Formation and evolution of disk galaxies at high redshifts
- Galactic archaeology and the early Milky Way
- Globular clusters in early structure formation
- Metal-free and nearly metal-free stars
...
- Dr. David Nataf (Johns Hopkins University)
...
- Prof. Chin-Fei Lee (Academia Sinica Institute of Astronomy and Astrophysics)
- Prof. Khee-Gan Lee (Kavli IPMU)
- Prof. Roberto Maiolino (University of Cambridge)
- Prof. Dante Minniti (Universidad Andres Bello)
- Dr. Premana Wardayanti Premadi (Bandung Institute of Technology)
...
- Mohamad Ridhauddin Mat Sabri (Universiti Malaya)
- Mohd Shaiful Rizal Hassan (Universiti Malaya)
...
- `css/` - Stylesheets
- `js/` - JavaScript files
- `img/` - Images, photos, and media assets
  - `gallery/` - Conference and venue photos
  - `speakers/` - Speaker photos
  - `IAUS_2023/` - Main conference photos
  - `IAUS_Monsoon_School_2023/` - Monsoon school photos
- `video/` - Video files (compressed for web)
...
Social Media:
- Facebook: [@IAUS377](https://www.facebook.com/IAUS377)
- Twitter: [@IAUS377](https://twitter.com/IAUS377)

## License

© IAU Symposium 377 Organizing Committee. All rights reserved.
